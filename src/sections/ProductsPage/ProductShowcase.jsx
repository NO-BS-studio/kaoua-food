...
const products = [
  {
    ...
    descriptionAR:
      "مجموعة متعددة الاستخدامات من معاجين الشوكولاتة الكريمية، والشوكولاتة المحشوة والبسكويت. تقدم أوبتيلا نكهات كلاسيكية ومغرية مثل البندق والكراميل للحظات حلاوة يومية.",
    images: [
  ...
  },
  {
    ...
    descriptionAR:
      "تُعرّف MOON EXCELLENCE الجودة الفاخرة بمعاجين البندق الغنية والذواقة. مصنوعة من 13% من البندق الحقيقي، إنها المتعة القصوى لأصحاب الذوق الراقي.",
  ...
  },
  {
    ...
    descriptionAR:
      "تتخصص بانادو في الطلاءات المركبة عالية الجودة بأنواع الشوكولاتة الداكنة والحليب والبيضاء. مثالية للخبز والحلويات أو للاستمتاع بها كسناك شهي.",
  ...
  },
  {
    ...
    descriptionAR:
      "اكتشف ألواح الشوكولاتة المحشوة من هِنينَا، حيث تكشف القشرة الناعمة عن انفجار من النكهات الفاكهية أو الكريمية. كل قطعة مفاجأة لذيذة مناسبة للمشاركة.",
  ...
  },
  {
    ...
    descriptionAR:
      "دلل نفسك بحلويات نابوليتانو الطرية التي تقدم قوامًا طريًا فريدًا ونكهات فاكهية حيوية. حلويات مرحة وملونة تذوب في الفم.",
  ...
  },
  {
    ...
    descriptionAR:
      "تجلب دويدوي البهجة بحلوى الجيلي الطرية والفواكه بنكهات طبيعية متعددة. هذه الحلوى الخفيفة والمطاطية خيار ممتع وخالٍ من الغلوتين لجميع الأعمار.",
