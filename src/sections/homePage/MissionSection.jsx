      ...
      <div className=" mx-auto grid grid-cols-2  relative z-10 px-[15vw]">
        ...
        <div className="flex flex-col col-span-2 md:col-span-1 gap-[1.5vw]">
          ...
          <div className="relative w-full">
            <div className="absolute w-fit md:-top-[1vw] md:left-[1vw] ltr:right-0 rtl:left-0  rotate-[-5deg] bg-green-700 text-white font-bold px-[2vw] py-[0.5vw] rounded-md shadow">
              <span className="md:text-[1.5vw] text-[3vw]">{t("homePage.section4.badge")}</span>
            </div>
          </div>
